var submitForm = (e: any) => {
  ...
  var pic = document.getElementById("pic") as HTMLInputElement;
  ...
  var zip = document.getElementById("zip") as HTMLInputElement;
  var country = document.getElementById("country") as HTMLInputElement;
  var box = document.getElementById("box") as HTMLInputElement;
